...
gsap.to("#page2>h1>span", {
   scrollTrigger: {  // Corrected to 'scrollTrigger'
      trigger: '#page2>h1>span',  // Corrected to the parent element '#page2>h1'
      start: 'top bottom',
      end: 'bottom top',
      scroller: `#main`,
      scrub: 0.5,
...
gsap.to("#page4>h1>span", {
   scrollTrigger: {  // Corrected to 'scrollTrigger'
      trigger: '#page4>h1>span',  // Corrected to the parent element '#page2>h1'
      start: 'top bottom',
      end: 'bottom top',
      scroller: `#main`,
      scrub: 0.5,
...
gsap.to("#page6>h1>span", {
   scrollTrigger: {  // Corrected to 'scrollTrigger'
      trigger: '#page6>h1>span',  // Corrected to the parent element '#page2>h1'
      start: 'top bottom',
      end: 'bottom top',
      scroller: `#main`,
      scrub: 0.5,
...
btn.addEventListener('click', () => {
   ...
   btn.style.backgroundColor =
      (sideNav.classList.contains("hidden") ? "transparent" : "blue");
   btn.style.borderColor =
      (sideNav.classList.contains("hidden") ? "white" : "blue");



   btn.innerHTML = (sideNav.classList.contains("hidden") ? `                  <i class="ri-menu-5-fill" style="font-size: 17px;">
   </i>` : `<img src="/add-fill (1).png"  width="100%" style="transform: rotate(45deg);display: inline-block;" alt="">`);
});
